...
<div    onMouseEnter={handleMouseEnter}
  ...
  <div className="carousel-inner">
    ...
    <div className="carousel-caption d-none d-md-block">
        <h5 className="text-info text-opacity-75">EL aprendizaje es vital</h5>
        <p className="text-info text-opacity-75">"Solo hay un bien, el conocimiento, y un mal, la ignorancia." - Sócrates.</p>
      </div>
     </div>
